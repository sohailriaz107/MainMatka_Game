            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">New Update Available </h1>
	                        <p class="hero-paragraph">All Bug Fixed. New payment Gateway. Fast Withdrawal. New Look</p>
							<p class="hero-paragraph">Note: Delete Old Application before insting New one.</p>
	                        <div class="hero-cta">
	                            
	                           <!-- <a class="button button-shadow" href="https://matkabooking.com">Website </a>-->
	                            <a class="button button-shadow" href="https://matkabooking.app/"> <i class="fa fa-android"></i> &nbsp;&nbsp; Download Now </a>
	                           <!-- <a class="button button-primary button-shadow" href="https://api.whatsapp.com/send?phone=917219912314&text=Hello%20From%20matkabooing.com">Whatsapp</a> -->
	                       </div>
						</div>
