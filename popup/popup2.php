            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">IPL Betting Online</h1>
	                        <p class="hero-paragraph">100% Genuine Online Cricket Khele</p>
	                        <p class="hero-paragraph">Fast Withdrawal - Trusted by Matkabooking</p>
	                        <div class="hero-cta">
	                            
	                           <!-- <a class="button button-shadow" href="https://matkabooking.com">Website </a>-->
	                            <a class="button button-shadow" href="https://onlinecricbet.in"> <i class="fa fa-play"></i> &nbsp;&nbsp; Play now </a>
