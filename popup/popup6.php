            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">MatkaBooking PRO - Extra Features</h1>
	                        <p class="hero-paragraph">To get extra benefits of your application kindly download our PRO application.</p>
	                        <div class="hero-cta">
	                            
	                           <!-- <a class="button button-shadow" href="https://matkabooking.com">Website </a>-->
	                            <a class="button button-shadow" href="https://play.google.com/store/apps/details?id=my.mb.games"> <i class="fa fa-android"></i> &nbsp;&nbsp; Download Now </a>
