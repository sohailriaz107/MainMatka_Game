                ...
                <div class="card shadow-sm border-0 mb-3 transition" style="border-radius: 16px;">
                    <div class="card-body p-3 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="text-muted d-block" style="font-size:12px;"><i class="fa fa-gamepad"></i> <?php echo get_gameNameById($row['game_id']);?> <span class="badge badge-light border">Digit: <?php echo $row['digit'];?></span></small>
